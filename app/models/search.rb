...
class Search < ActiveRecord::Base
  ...
  validates_presence_of :answer_open, :if => Proc.new{ |f| (f.step > 2 && (f.ad_test == 0 || f.ad_test == 3)) || (f.step > 4 && (f.ad_test == 1 || f.ad_test == 2)) }
  validates_presence_of :answer_discrete, :if => Proc.new{ |f| (f.step > 2 && (f.ad_test == 1 || f.ad_test == 2)) || (f.step > 4 && (f.ad_test == 0 || f.ad_test == 3)) }
